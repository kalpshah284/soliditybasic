...
contract DutchAuction {
    ...
    uint public immutable expierAt;
    ...
    constructor(
        ...
        uint _nftId
            ...
            nftId = _nftId;
            nft = IERC721(_nft);
            require(_stratingPrice >= _discountRate * DURATION,"strating price < discount");
            startAt = block.timestamp;
            expierAt = startAt + DURATION;
    ...
    function buy() external payable {
        require(block.timestamp < expierAt,"auction expire");
